...
export const TIER_STYLES: TierStyle[] = [
  { tier: 1, name: 'Iniciante', minLevel: 1, maxLevel: 3, weeklyAllowance: 5, gradient: 'from-slate-400 to-slate-500', gradientBg: 'from-slate-50 to-slate-100', color: 'text-slate-600', bg: 'bg-slate-100', border: 'border-slate-200', badge: 'bg-slate-100 text-slate-600', dot: 'bg-slate-400', icon: '🌱' },
